...
Uint8 Pixel::r() const { return data & 0xFF; }

Uint8 Pixel::g() const { return data >> 8 & 0xFF; }

Uint8 Pixel::b() const { return data >> 16 & 0xFF; }

Uint8 Pixel::a() const { return data >> 24 & 0xFF; }
...
void Pixel::a(const Uint8 alpha) { data = (data & 0x00FFFFFF) | (alpha << 24); }
