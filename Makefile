...
GENERATOR_CURRENT = $(GENERATOR_UNIX)
...
install: $(BUILD_DIR)
	cmake -DCMAKE_BUILD_TYPE:STRING=$(PROFILE_CURRENT) -DCMAKE_EXPORT_COMPILE_COMMANDS:BOOL=TRUE -G $(GENERATOR_CURRENT) -S . -B $(BUILD_DIR)
